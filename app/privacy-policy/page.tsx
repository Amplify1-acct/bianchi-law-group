...
export const metadata: Metadata = {
  title: 'Privacy Policy - The Bianchi Law Group',
  description: 'This Privacy Policy describes how The Bianchi Law Group, LLC collects and uses information.',
}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            <p className="text-lg text-gray-700 mb-6 leading-relaxed">
              This Privacy Policy describes how The Bianchi Law Group, LLC collects and uses information.
            </p>
