...
export const metadata: Metadata = {
  title: 'Terms of Service - The Bianchi Law Group',
  description: 'These Terms of Service govern your use of The Bianchi Law Group website.',
}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            <p className="text-lg text-gray-700 mb-6 leading-relaxed">
              These Terms of Service govern your use of The Bianchi Law Group website.
            </p>
