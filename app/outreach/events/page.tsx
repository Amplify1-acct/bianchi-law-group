...
export const metadata: Metadata = {
  title: 'Events - Bianchi Law Group Outreach',
  description: 'The Bianchi Law Group community outreach program: Events. Giving back to New Jersey communities.',
}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            <p className="text-lg text-gray-700 mb-6 leading-relaxed">
              The Bianchi Law Group is proud to offer the Events program as part of our commitment to serving New Jersey communities beyond the courtroom. Learn more about how we can help.
            </p>
